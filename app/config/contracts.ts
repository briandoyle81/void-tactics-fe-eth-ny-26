import ShipsContract from "../contracts/base-sepolia/artifacts/DeployModule#Ships.json";
import LobbiesContract from "../contracts/base-sepolia/artifacts/DeployModule#Lobbies.json";
import FleetsContract from "../contracts/base-sepolia/artifacts/DeployModule#Fleets.json";
import GameContract from "../contracts/base-sepolia/artifacts/DeployModule#Game.json";
import UniversalCreditsContract from "../contracts/base-sepolia/artifacts/DeployModule#UniversalCredits.json";
import MapsContract from "../contracts/base-sepolia/artifacts/DeployModule#Maps.json";
import ShipAttributesContract from "../contracts/base-sepolia/artifacts/DeployModule#ShipAttributes.json";
import DroneYardContract from "../contracts/base-sepolia/artifacts/DeployModule#DroneYard.json";
import DroneEnergyCoresContract from "../contracts/base-sepolia/artifacts/DeployModule#DroneEnergyCores.json";
import TutorialClaimContract from "../contracts/base-sepolia/artifacts/DeployModule#TutorialClaim.json";
import ShipPurchaserContract from "../contracts/base-sepolia/artifacts/DeployModule#ShipPurchaser.json";
import TournamentContract from "../contracts/base-sepolia/artifacts/DeployModule#Tournament.json";
import GameBlobRegistryContract from "../contracts/base-sepolia/artifacts/DeployModule#GameBlobRegistry.json";
import SinglePlayerMatchContract from "../contracts/base-sepolia/artifacts/DeployModule#SinglePlayerMatch.json";
import AIEncountersContract from "../contracts/base-sepolia/artifacts/DeployModule#AIEncounters.json";
import PvPMatchContract from "../contracts/base-sepolia/artifacts/DeployModule#PvPMatch.json";
import NodeMapContract from "../contracts/base-sepolia/artifacts/DeployModule#NodeMap.json";
import AIShipsContract from "../contracts/base-sepolia/artifacts/DeployModule#AIShips.json";
import ShipsRouterContract from "../contracts/base-sepolia/artifacts/DeployModule#ShipsRouter.json";
import DroneStorefrontContract from "../contracts/base-sepolia/artifacts/DeployModule#DroneStorefront.json";
import FreeShipClaimContract from "../contracts/base-sepolia/artifacts/DeployModule#FreeShipClaim.json";
import RamResolverContract from "../contracts/base-sepolia/artifacts/DeployModule#RamResolver.json";
import RepairResolverContract from "../contracts/base-sepolia/artifacts/DeployModule#RepairResolver.json";
import DroneNamesContract from "../contracts/base-sepolia/artifacts/DeployModule#DroneNames.json";
import VariantPurchaseGateContract from "../contracts/base-sepolia/artifacts/DeployModule#VariantPurchaseGate.json";
import ShatteredHiveMedalContract from "../contracts/base-sepolia/artifacts/DeployModule#ShatteredHiveMedal.json";
import RoguelikeNodeMapContract from "../contracts/base-sepolia/artifacts/DeployModule#RoguelikeNodeMap.json";
import RoguelikeRunContract from "../contracts/base-sepolia/artifacts/DeployModule#RoguelikeRun.json";
import RoguelikeMatchContract from "../contracts/base-sepolia/artifacts/DeployModule#RoguelikeMatch.json";
import RoguelikeResupplyContract from "../contracts/base-sepolia/artifacts/DeployModule#RoguelikeResupply.json";
import RandomManagerContract from "../contracts/base-sepolia/artifacts/DeployModule#RandomManager.json";
import NodeContentRegistryContract from "../contracts/base-sepolia/artifacts/DeployModule#NodeContentRegistry.json";
import DECBonusWinEffectContract from "../contracts/base-sepolia/artifacts/DeployModule#DECBonusWinEffect.json";
import HealAboveFloorWinEffectContract from "../contracts/base-sepolia/artifacts/DeployModule#HealAboveFloorWinEffect.json";
import ShipGrantWinEffectContract from "../contracts/base-sepolia/artifacts/DeployModule#ShipGrantWinEffect.json";
import FactionRewardTokenRegistryContract from "../contracts/base-sepolia/artifacts/DeployModule#FactionRewardTokenRegistry.json";
import SelfieCheckEligibilityProviderContract from "../contracts/base-sepolia/artifacts/DeployModule#SelfieCheckEligibilityProvider.json";
