...
import type { Web2Ship, Web2ShipEquipment, Web2ShipTraits, Web2ShipData } from "../types/web2Ship";

export function dbShipToShip(db: DbShip): Web2Ship {
  const equipment = db.equipment as unknown as Web2ShipEquipment;
