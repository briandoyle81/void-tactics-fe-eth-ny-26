...
interface FleeSafetySwitchWeb2Props {
  gameId: number;
  onFlee?: () => void;
...
// Web2-mode counterpart to `FleeSafetySwitch.tsx` — identical lever/confirm
// UI, but the confirm button calls `/api/games/[id]/flee` directly instead
// of a `TransactionButton` contract call.
export function FleeSafetySwitchWeb2({
  gameId,
  onFlee,
  locked = false,
}: FleeSafetySwitchWeb2Props) {
