...
const AuthSignIn: React.FC = () => {
  ...
  const handleSignIn = () => {
    posthog.capture("web2_sign_in_clicked");
    void signIn("google");
  };
  ...
  return (
    <button
      ...
      type="button"
      className="border-2 border-amber text-amber hover:bg-amber/10 uppercase font-semibold py-2 px-6 tracking-wider transition-colors duration-150"
      style={{
